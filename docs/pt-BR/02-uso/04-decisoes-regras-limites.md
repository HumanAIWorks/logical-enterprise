...
como tratar esses três elementos
de forma clara, simples e reutilizável.
...
Regras não tomam decisões.
Elas **orientam** decisões.
...
Quando essa relação não está clara,
o caos aparece.
...
Uma decisão pode ser registrada
respondendo a poucas perguntas:
...
Exceções explícitas
preservam a coerência.

---

## Evitando decisões contraditórias

Antes de tomar uma nova decisão,
verifique:
...
o conflito precisa ser tratado
antes da execução.
...
Clareza nesses três pontos
é o que mantém o modelo vivo.

---

## 👉 Próxima leitura recomendada

Agora que decisões, regras e limites estão claros,
o próximo passo é entender
**como documentar tudo isso de forma sustentável**.
